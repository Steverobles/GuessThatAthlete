...
const nflQuestionsAndAnswers = [
    { Athlete:'Derwin James', Message:'This NFL player plays for the Los Angeles Chargers. He came out of FSU as a safety and is regarded as one of the best defensive players in the league.'},
    { Athlete:'Tom Brady' ,Message:'This NFL player has 7 rings and most recently got his last one with the Tampa Bay Buccaneers.'  },
    { Athlete:'Patrick Mahomes' , Message:'This NFL player plays for the Kansas City Chiefs and is one of the best quarterbacks in the nfl.'},
    { Athlete:'Saquon Barkley', Message:'This NFL player is a running back out of penn state who plays for the New York Giants.' },
    { Athlete:'Joey Bosa', Message:'This NFL player came out of ohio state who plays as a defensive end and has a brother who plays the same position for the San Francisco 49ers.'},
    { Athlete:'Justin Jefferson', Message:'This NFL player came out of LSU as a wide receiver. Currently plays for the Minnesota Vikings.'}
  ];
